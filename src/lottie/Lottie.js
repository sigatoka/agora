...
export default class Lottie extends React.Component {
  componentDidMount() {
    ...
    this.anim.onLoopComplete = (prop) => {
      console.log("Loop complete",prop)
    }
    this.anim.onEnterFrame = (prop) => {
  ...
  render() {
    ...
    const onClickHandler = isClickToPauseDisabled ? () => null : null;
    ...
    return (
      ...
      <div
        ...
        style={lottieStyles}
        onClick={onClickHandler||this.props.onClick}
        title={title}
        role={ariaRole}
